...
await updateDoc(walletRef, {
  'wallet.nonCarbonCredits': increment(10),
  'wallet.carbonCredits': increment(carbonImpact > 0 ? 1 : 0),
});
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput style={styles.input} placeholder="Category (e.g. Waste, Water)" value={category} onChangeText={setCategory} />
